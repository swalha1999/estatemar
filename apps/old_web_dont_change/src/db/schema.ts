...
export const email_verification_requests = pgTable(
...
export const password_reset_sessions_relations = relations(
...
export const property_types_relations = relations(
	property_types,
	({ many }) => ({
...
export const property_statuses_relations = relations(
	property_statuses,
	({ many }) => ({
		properties: many(properties),
	}),
...
export const property_amenities_relations = relations(
	property_amenities,
	({ one }) => ({
...
export const property_images_relations = relations(
	property_images,
	({ one }) => ({
		property: one(properties, {
...
export const property_agents_relations = relations(
	property_agents,
	({ one }) => ({
		property: one(properties, {
...
export const project_units = pgTable("project_units", {
	...
	unit_image_id: integer("unit_image_id").references(() => files.id, {
		onDelete: "set null",
	}),
...
export const project_images_relations = relations(
	project_images,
	({ one }) => ({
		project: one(projects, {
...
export const project_amenities = pgTable(
	...
	(table) => ({
		...
		projectIdIdx: index("project_amenities_project_id_idx").on(
			table.project_id,
		),
		amenityIdIdx: index("project_amenities_amenity_id_idx").on(
			table.amenity_id,
		),
	}),
);

export const project_amenities_relations = relations(
	project_amenities,
	({ one }) => ({
		project: one(projects, {
...
export type EmailVerificationRequest = InferSelectModel<
	typeof email_verification_requests
>;
export type PasswordResetSession = InferSelectModel<
	typeof password_reset_sessions
>;
