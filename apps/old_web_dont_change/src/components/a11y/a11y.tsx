...
const AccessibilityButton = ({ params: { lng } }: { params: { lng: string } }) => {
    ...
    return (
        <div className="fixed left-0 top-1/2 -translate-y-1/2 z-50 flex flex-col">
            <button onClick={toggleMenu} className="bg-black text-white p-2 rounded-r">
                <Image src={disabledIcon} alt="Accessibility" width={16} height={16} />
            </button>
            {isOpen && (
                <div className="bg-white border border-black p-2.5 mt-1.5 rounded-r">
