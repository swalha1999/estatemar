...
export default function Navbar({ params: { lng } }: { params: { lng: string } }) {
    ...
    return (
        <nav className={`navbar ${scrolled ? "scrolled" : ""}`}>
            <div className="navbar-content">
                ...
                <div className="navbar-links-container">
                    ...
                    <div className="navbar-links">
                        <Link href={`/${lng}/articles`} className="nav-link" prefetch={true}>
                            {t("navigationBar.articles")}
                        </Link>
                        <Link href={`/${lng}/partners`} className="nav-link" prefetch={true}>
            ...
            <div className={`hamburger ${isDrawerOpen ? "hidden" : ""}`} onClick={toggleDrawer}>
                <div></div>
                <div></div>
                <div></div>
            </div>
