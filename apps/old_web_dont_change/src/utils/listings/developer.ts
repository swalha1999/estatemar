...
export const getDeveloperById = async (id: number): Promise<DeveloperWithLogo | null> => {
...
export const getDeveloperBySlug = async (slug: string): Promise<DeveloperWithLogo | null> => {
...
export const updateDeveloper = async (developer: Developer & { logo_id?: number }) => {
    const { logo_id, ...rest } = developer;
    await db
        .update(developers)
...
export const getDeveloperProjects = async (developerId: number): Promise<Project[]> => {
