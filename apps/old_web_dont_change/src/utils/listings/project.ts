...
export const updateProject = async (id: number, project: CreateProjectData) => {
    ...
    await db.delete(project_images).where(eq(project_images.project_id, newProjectId));
    await db.delete(project_files).where(eq(project_files.project_id, newProjectId));
    await db.delete(project_amenities).where(eq(project_amenities.project_id, newProjectId));
