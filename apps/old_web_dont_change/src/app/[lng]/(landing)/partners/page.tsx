...
export async function generateMetadata(props: { params: Promise<{ lng: string }> }) {
...
export default async function PartnersPage(props: { params: Promise<{ lng: string }> }) {
    const params = await props.params;
                ...
                {developers.map((developer) => (
                    ...
                    >
                        <div className={styles.partnerCard}>
                            ...
                            <p className={styles.partnerDescription}>{developer.description}</p>
                        </div>
                    </Link>
                ))}
            </div>
