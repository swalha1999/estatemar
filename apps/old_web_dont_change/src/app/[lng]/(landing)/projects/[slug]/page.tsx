    ...
    return (
        <div className={`${styles.container} ${styles[lng]}`}>
            ...
            <div className={styles.section}>
                ...
                <ProjectImages images={project.images} projectName={project.name} t={t} />
            </div>
            ...
            <div className={styles.section}>
                ...
                <ul className={styles.list}>
                    {project.amenities.map((amenity, index) => (
                        <li
                            key={index}
                            className="flex items-center gap-3 py-2 px-4 rounded-lg bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-colors duration-200 shadow-sm"
                        >
                            <Icon
