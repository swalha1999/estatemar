						...
						<div className="rounded-lg bg-sidebar-accent p-4">
							<div className="flex flex-col items-center text-center">
								...
								<div className="space-y-1">
									...
									<div className="flex flex-col items-center justify-center gap-1 text-sidebar-foreground/70 text-sm">
								...
								<button
									type="submit"
									className="mt-4 flex w-full items-center justify-center gap-2 rounded-md px-3 py-2 text-red-600 text-sm transition-colors hover:bg-red-50 hover:text-red-700 dark:hover:bg-red-950/50"
